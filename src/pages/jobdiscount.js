      ...
      <div id="main">
        <section id="one">
          ...
          <div style={{display: 'flex'}}>
              ...
              <a style={{marginLeft: "auto", marginRight: "auto" , textAlign: 'center' }} href="https://github.com/Gabinrn/Epitech-Project-Web" target="_blank" rel="noopener" className="button"><i class="icon fa-github" style={{marginRight: "4px"}} > </i>GitHub </a>
          </div>
        </section>
